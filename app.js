...
const mQuestionsAll = [
    ...
    [`Learning - Punishment`, ``, ``, ``, ``, ``, `<p class='space'>Get you to stop doing something<p class='space'>Discourage undesirable behaviors by giving negative consequences or withholding positive consequences`, `HRM360-CH06`],
    ...
    [`When group members feel comfortable disagreeing with other group members`, ``, ``, ``, ``, ``, `<p class='space'>Minority dissent `, `HRM360-CH11-book`],
    [`Intuition `, ``, ``, ``, ``, ``, `<p class='space'>Intuition consists of judgments, insights, or decisions that “come to mind on their own, without explicit awareness of the evoking cues and of course without explicit evaluation of the validity of these cues.”<p class='space'>We all have the ability to use intuition.`, `HRM360-CH11-book`],
    [`Expertice vs tacit knowledge`, ``, ``, ``, ``, ``, `<p class='space'>Expertise is an individual’s combined explicit knowledge or information that can easily be put into words, and <p class='space'>tacit knowledge or information we gain through experience that is difficult to express and formalize.`, `HRM360-CH11-book`],
    [`Electronic brainstorming - aka brainwriting`, ``, ``, ``, ``, ``, `<p class='space'>Electronic brainstorming, sometimes called brainwriting, allows participants to submit their ideas and alternatives over a computer network. Webinars work well for this purpose.`, `HRM360-CH11-book`]
    [`The Delphi technique`, ``, ``, ``, ``, ``, `<p class='space'>The Delphi technique is a group process that generates anonymous ideas or judgments from physically dispersed experts in multiple rounds of brainstorming.`, `HRM360-CH11-book`],
    [` Decision support systems`, ``, ``, ``, ``, ``, `<p class='space'>Decision support systems (DSS) are “computer-based interactive systems that help decision makers to use data and models to solve unstructured problems`, `HRM360-CH11-book`]

...
const mQuestionsAll = [
    ...
    [`1. What is the difference between Data and Information?`, ``, ``, ``, ``, ``, `<p class='space'>Data consists of raw facts where information results from processing raw information. <p class='space'>Information is the result of processing raw data to reveal its meaning.`, `IS380-ch01`],
    ...
    [`What is a Database Model and why is it important?`, ``, ``, ``, ``, ``, `<p class='space'>A data model is a relatively simple representation, usually graphical, of more complex real-world data structures. <p class='space'>a model is an abstraction of a more complex real-world object or event. <p class='space'>This blueprint is narrative and graphical in nature, meaning that it contains both text descriptions in plain, unambiguous language and clear, useful diagrams depicting the main data elements. <p class='space'>It is important because it provides a clear picture of how the pieces of a business fit together, this allows the development of an effective database.`, `IS380-ch02`],
    ...
    [`What is entity integrity?`, ``, ``, ``, ``, ``, `<p class='space'>The property of a relational table that guarantees each entity has <p class='space'>(1)a unique value in a primary key and that <p class='space'>(2)the key has no null values.`, `IS380-ch03`],
    [`What is referential integrity?`, ``, ``, ``, ``, ``, `<p class='space'>A condition by which a dependent table’s foreign key must have <p class='space'>(1)either a null entry or <p class='space'>(2)a matching entry in the related table.`, `IS380-ch03`],
    ...
    [`Purpose of ERD:`, ``, ``, ``, ``, ``, `<p class='space'>the ERD is used for communication between designers and end users.`, `IS380-ch04`],

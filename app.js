...
const mQuestionsAll = [
    ...
    [`Three components of operant conditioning:`, ``, ``, ``, ``, ``, `<p class='space'>(1) A stimulus in the environment cues attention to a behavior<p class='space'>(2) Behavior occurs in response to a stimulus<p class='space'>(3) Outcomes are the consequences of our behavior `, `HRM360-CH06`],
    [`Learning - Reinforcement: `, ``, ``, ``, ``, ``, `<p class='space'>Enhances desirable behavior by giving positive consequences, or withholding negative ones`, `HRM360-CH06`],
    [`Learning - Extinction`, ``, ``, ``, ``, ``, `<p class='space'>Weakening a behavior by ignoring it or making sure it is not reinforced is referred to as extinction<p class='space'>Attaching no consequence to an undesired behavior; this may be the most effective when used alongside positive reinforcement (for desired behaviors)`, `HRM360-CH06`],
    [`Learning - Punishment`, ``, ``, ``, ``, ``, `<p class='space'>Discourage undesirable behaviors by giving negative consequences or withholding positive consequences`, `HRM360-CH06`],
    ...
    [`What is Social Learning Theory?`, ``, ``, ``, ``, ``, `<p class='space'>Social learning theory asserts that people observe others, and model their behavior accordingly; <p class='space'>Learning is enhanced when learners have high task-specific self-efficacy (which means they believe they can do something)`, `HRM360-CH06`],
    ...
    [`Smart Goals`, ``, ``, ``, ``, ``, `<p class='space'>Smart - an acronym for: <p class='space'>Specific<p class='space'>Measurable<p class='space'>Attainable<p class='space'>Results oriented<p class='space'>Time bound`, `HRM360-CH06`],
    [`Performance Management - There are two general categories of performance behavior:`, ``, ``, ``, ``, ``, `<p class='space'>(1) Task performance: <p class='space'>Work-related tasks/goals (e.g., financial goals, administrative tasks, production, etc.)<p class='space'> (2) Contextual performance: <p class='space'>Support the social environment (e.g., helping, cooperating, providing social support) – organizational citizenship behavior `, `HRM360-CH06`],
    ...
    [`Commitment to goals can be enhanced by:`, ``, ``, ``, ``, ``, `<p class='space'>(1) Highlighting the importance of the goal: <p class='space'>making commitment public, validation and support from leaders, participative goal-setting, financial compensation<p class='space'>  (2) Boosting an employee’s goal-specific self-efficacy: <p class='space'>Adequate training/development, role-modeling (social learning theory), persuasive/inspirational communication `, `HRM360-CH06`],
    ...
    [`Team formation - Norming:`, ``, ``, ``, ``, ``, `<p class='space'>Norming: Roles/responsibilities become clear and consensually accepted<p class='space'>Agreement and consensus<p class='space'>Clear roles and responsibilies<p class='space'>(Facilitation) `, `HRM360-CH08`],
